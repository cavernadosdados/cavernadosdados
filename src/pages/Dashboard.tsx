  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold glow-gold">Pronto pra próxima aventura, {displayName}!</h1>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card className="bg-card border-border hover:border-primary transition-mystical">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{userType === "master" ? "Jogadores" : "Sessões"}</CardTitle>
        ...
        {userType === "master" ? (
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card className="bg-gradient-to-br from-card to-card/50 border-secondary/50">
                <CardHeader>
                  ...
                  <CardDescription>Visualizações e engajamento</CardDescription>
                </CardHeader>
          ...
          <>
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">Explore mesas incríveis criadas por mestres experientes</p>
